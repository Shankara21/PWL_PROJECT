        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="dropdown text-end navbar-nav">
                    <a href="#" class="d-block link-dark text-decoration-none dropdown nav-item nav-link"
                        id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <span>{{Auth::user()->username}}</span>
                        {{-- <img src="https://github.com/mdo.png" alt="mdo" width="32" height="32" class="rounded-circle"> --}}
                    </a>
                    <div class="dropdown-menu " style="transform: translateX(-20px)">
                        <a href="/profile" class="dropdown-item"><i class="fas fa-user"></i> Profile </a>
                        <a href="/dashboard" class="dropdown-item"><i class="fas fa-home"></i>Dashboard </a>
