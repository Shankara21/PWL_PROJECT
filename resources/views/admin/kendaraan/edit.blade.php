            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/dashboard/kendaraan/{{$kendaraan->slug}}" method="POST" class="mb-5" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="mb-3">
                                    ...
                                    @enderror" id="nama" name="nama" required autofocus value="{{ old('nama', $kendaraan->nama) }}">
                                    @error('nama')
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <select class="default-select form-control wide mb-3" name="brand_id">
                                      @foreach ($brands as $brand)
                                        <option value="{{ $brand->id }}" {{ $kendaraan->brand_id == $brand->id ? 'selected' : '' }}>{{ $brand->nama }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                  <div class="mb-3">
                                    ...
                                    <select class="default-select form-control wide mb-3" name="category_id">
                                      @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ $kendaraan->category_id == $category->id ? 'selected' : '' }}>{{ $category->nama }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                  <div class="mb-3">
                                    ...
                                    @enderror" id="warna" name="warna" required autofocus value="{{ old('warna', $kendaraan->warna) }}">
                                    @error('warna')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror" id="tahun" name="tahun" required autofocus value="{{ old('tahun', $kendaraan->tahun) }}">
                                    @error('tahun')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror" id="harga" name="harga" required autofocus value="{{ old('harga', $kendaraan->harga) }}">
                                    @error('harga')
                                      <div class="invalid-feedback">
                                        {{ $message }}
                                      </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @endif" class="img-preview mb-3 " alt="{{ $kendaraan -> nama }}" height="200px" width="200px">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    @enderror
                                    <input id="deskripsi" type="hidden" name="deskripsi" value="{{ old('deskripsi', $kendaraan->deskripsi) }}">
