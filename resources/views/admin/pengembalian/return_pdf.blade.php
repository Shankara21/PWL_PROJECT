    ...
    <main>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td class="service">{{ $return->pengembalian_id }}</td>
                    <td class="service">{{ $return->pengembalian->user->name }}</td>
                    <td class="service">{{ $return->pengembalian->user_id }}</td>
                    <td class="service">{{ $return->tanggal_kembali }}</td>
                </tr>
                @endforeach
