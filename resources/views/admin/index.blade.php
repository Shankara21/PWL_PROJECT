								...
								<div class="card tryal-gradient">
									<div class="card-body tryal row">
										<div class="col-xl-7 col-sm-6">
											...
											<a href="javascript:void(0);" class="btn btn-rounded  fs-18 font-w500">Try
												Free Now</a>
										</div>
									...
									<div class="card-body px-0">
										<div class="d-flex justify-content-between recent-emails">
											<div class="d-flex">
												...
												<div class="ms-3">
													<h4 class="fs-18 font-w500">How to improve project management flows
													</h4>
										...
										<div class="d-flex justify-content-between recent-emails">
											<div class="d-flex">
												<div class="profile-k">
													<img src="{{asset('admin/images/profile/small/pic6.jpg')}}" alt="">
												</div>
												<div class="ms-3">
										...
										<div class="d-flex justify-content-between recent-emails">
											<div class="d-flex">
												...
												<div class="ms-3">
													<h4 class="fs-18 font-w500">Weekly Design Inspirations by Envato
													</h4>
													<span class="font-w400 d-block">Lorem ipsum dolor sit amet,
														consectetur adipiscing elit, sed do<br> eiusmod tempor
														incididunt ut labore et dolore magna aliqua...</span>
										...
										<div class="d-flex justify-content-between recent-emails">
											<div class="d-flex">
												<div class="profile-k">
													<img src="{{asset('admin/images/profile/small/pic8.jpg')}}" alt="">
												</div>
												<div class="ms-3">
													<h4 class="fs-18 font-w500">How to improve project management flows
													</h4>
								...
								<div class="card-body">
									<ul class="p-0 m-0">
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/Shopeepay.png') }}" alt="User"
												class="rounded" width="100px">

											<div
												class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2 mx-2">
												<div class="me-2">
										...
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/LinkAja.png') }}" alt="User"
												class="rounded" width="100px">
										...
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/Gopay.png') }}" alt="User" class="rounded"
												width="100px">
										...
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/BRI.png') }}" alt="User" class="rounded"
												width="100px">
										...
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/BCA.png') }}" alt="User" class="rounded"
												width="100px">
										...
										<li class="d-flex mb-4 pb-1">
											...
											<img src="{{ asset('img/payments/Mandiri.png') }}" alt="User"
												class="rounded" width="100px">
											...
											<div class="card-body pb-0">
												<div class="project-details">
													<div class="d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<span class="big-wind">
																<img src="{{asset('admin/images/big-wind.png')}}"
																	alt="">
															</span>
															<div class="ms-3">
																<h4>Big Wind</h4>
													...
													<h4 class="fs-16 font-w600 mt-4">Optimization Dashboard Page for
														indexing in Google</h4>
													<div class="projects">
														<span
												...
												<div class="project-details">
													<div class="d-flex align-items-center justify-content-between">
														<div class="d-flex align-items-center">
															<span class="big-wind">
																<img src="{{asset('admin/images/circle-hunt.png')}}"
																	alt="">
															</span>
															<div class="ms-3">
																<h4>Circle Hunt</h4>
													...
													<h4 class="fs-16 font-w600 mt-4">Redesign Landing Page Website for
														Company Profile</h4>
													<div class="projects">
														<span
								...
								<div class="card">
									...
									<div class="card-body px-0">
										...
										<div class="msg-bx d-flex justify-content-between align-items-center">
											<div class="msg d-flex align-items-center w-100">
												<div class="image-box">
													<img src="{{asset('admin/images/profile/small/pic7.jpg')}}" alt="">
												</div>
												<div class="ms-3 w-100">
										...
										<div class="msg-bx d-flex justify-content-between align-items-center">
											<div class="msg d-flex align-items-center w-100">
												<div class="image-box active">
													<img src="{{asset('admin/images/profile/small/pic4.jpg')}}" alt="">
												</div>
												<div class="ms-3 w-100">
										...
										<div class="msg-bx d-flex justify-content-between align-items-center">
											<div class="msg d-flex align-items-center w-100">
												<div class="image-box active">
													<img src="{{asset('admin/images/profile/small/pic3.jpg')}}" alt="">
												</div>
												<div class="ms-3 w-100">
										...
										<div class="msg-bx d-flex justify-content-between align-items-center">
											<div class="msg d-flex align-items-center w-100">
												<div class="image-box active">
													<img src="{{asset('admin/images/profile/small/pic5.jpg')}}" alt="">
												</div>
												<div class="ms-3 w-100">
													<h4 class="fs-18 font-w600">Ann Rosser</h4>
													<div class="d-flex justify-content-between">
														<span class="me-auto">I dont’t know where that files saved
															dude.</span>
														<span class="me-4 fs-12">Yesterday, 8:24 AM</span>
													</div>
												</div>
